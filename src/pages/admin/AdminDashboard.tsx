        ...
        <TabsContent value="monitoring" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitore o desempenho e a integridade do sistema
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-md">
                  <div>
                    <h3 className="font-medium">Painel de Monitoramento</h3>
                    <p className="text-sm text-muted-foreground">
                      Acesse estatísticas detalhadas e monitore a saúde do
                      sistema
                    </p>
                  </div>
